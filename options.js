document.addEventListener('DOMContentLoaded', () => {
  ...
  chrome.storage.sync.get(['restrictedUrls', 'titleFormat', 'urlFormat'], ({ restrictedUrls, titleFormat, urlFormat }) => {
    if (restrictedUrls) {
...
function setDefaultMarkdownFormats() {
  ...
  chrome.storage.sync.set({ titleFormat: defaultTitleFormat, urlFormat: defaultUrlFormat });
}
